...
<body>
	...
	<hr>
	<div class="section">
        <p style="text-align: center; font-size: 50px; font-weight: bold;">MEDICARE DISPENSARY <img src="pics/mdlogo.PNG" style="width: 120px; height: 120px;"></p>
  	</div>
  	<hr>
  		...
  		<table style="border: solid black 0px; width: 100%; height: 300px;">
  			<tr style="border: solid black 0px;">
  				<td style="text-align: center;"><img src="pics/hosp.jpg" style="width: 900px; height: 400px;"></td>
  			</tr>
  		</table>
  		<br>
  		<hr>
  			<p style="text-align: center; font-size: 20px; font-style: italic;">Welcome to our MEDICARE DISPENSARY, We provide Medical Service that you can Trust 100% </p>
  		<hr>
  		<br>
